    ...
    <nav class="main-header navbar navbar-expand navbar-warning" style="background-color:seagreen;">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
          <a href="/beranda/profil panitia" class="nav-link" style=" font-weight: bold; color: White;">Profil</a>
        </li>
        <li class="nav-item d-none d-sm-inline-block" style="margin-left: 170px;">
      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              <a href="/beranda/panitia" class="nav-link" style=" font-weight: bold; color: white;">
            ...
            <li class="nav-item">
              <a href="/panitia/form nilai" class="nav-link" style=" font-weight: bold; color: white;">
            ...
            <li class="nav-item">
            <a href="#" class="nav-link" style=" font-weight: bold; color: white;">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="/laporan/hasil casis" class="nav-link" style=" font-weight: bold; color: white;">
              ...
              <li class="nav-item">
                <a href="/laporan/siswa lulus" class="nav-link" style=" font-weight: bold; color: white;">
                  <!-- <i class="fa fa-user-plus" aria-hidden="true"></i> -->
                  <i class="far fa-circle nav-icon"></i>
                  <p>Siswa Diterima</p>
                </a>
              ...
              <li class="nav-item">
                <a href="/laporan/siswa/tidak lulus" class="nav-link" style=" font-weight: bold; color: white;">
                  <!-- <i class="fa fa-user-plus" aria-hidden="true"></i> -->
                  <i class="far fa-circle nav-icon"></i>
